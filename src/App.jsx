			...
			<main className='main'>
				...
				<div className='last-box'>
					...
					<div className='last__box-inner'>
						<h3 className='last__box-inner-title'>Bamboo Stand</h3>
						<p className='last__box-inner-pledge'>Pledge $25 or more</p>
						...
						<div className='last__box-inner-left'>
							<p className='last__box-inner-left-price'>101</p>
							<p className='last__box-inner-left-text'>left</p>
						</div>
						<button className='last__box-inner-left-btn'>
							Select Reward
						</button>
					</div>
					<div className='last__box-inner'>
						<h3 className='last__box-inner-title'>Black Edition Stand</h3>
						<p className='last__box-inner-pledge'>Pledge $25 or more</p>
						<p className='last__box-inner-text'>
					...
					<div className='last__box-inner'>
						<h3 className='last__box-inner-title'>
							Mahogany Special Edition
						</h3>
						<p className='last__box-inner-pledge'>Pledge $200 or more</p>
						<p className='last__box-inner-text'>
						...
						<div className='last__box-inner-left'>
							<p className='last__box-inner-left-price'>0</p>
							<p className='last__box-inner-left-text'>Out of Stock</p>
						</div>
						<button className='last__box-inner-left-btn'>
							Out of Stock
						</button>
